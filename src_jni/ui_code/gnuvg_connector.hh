...
private:
	...
	class ConnectionGraphic : public KammoGUI::GnuVGCanvas::ElementReference, public std::enable_shared_from_this<ConnectionGraphic>  {
	private:
		...
		KammoGUI::GnuVGCanvas::ElementReference selectButton;
		...
		void debug_print();
	public:
		ConnectionGraphic(GnuVGConnector *context,
		...
		static std::shared_ptr<ConnectionGraphic> attach(GnuVGConnector *context,
								 std::shared_ptr<MachineGraphic> source,
								 std::shared_ptr<MachineGraphic> destination,
								 const std::string &output,
								 const std::string &input);
	...
	private:
		...
		class IOSocket : public KammoGUI::GnuVGCanvas::ElementReference {
		public:
			IOSocket(KammoGUI::GnuVGCanvas::ElementReference original,
				 KammoGUI::GnuVGCanvas::ElementReference socket_gfx,
		...
		// Socket data
		KammoGUI::GnuVGCanvas::ElementReference socket_container;
		...
		KammoGUI::GnuVGCanvas::SVGMatrix selection_indicator_base_t;
		...
		static void on_event(KammoGUI::GnuVGCanvas::SVGDocument *source,
				     KammoGUI::GnuVGCanvas::ElementReference *e_ref,
				     const KammoGUI::MotionEvent &event);
		static void on_output_socket_event(KammoGUI::GnuVGCanvas::SVGDocument *source,
						   KammoGUI::GnuVGCanvas::ElementReference *e_ref,
						   const KammoGUI::MotionEvent &event);
		static void on_input_socket_event(KammoGUI::GnuVGCanvas::SVGDocument *source,
						  KammoGUI::GnuVGCanvas::ElementReference *e_ref,
						  const KammoGUI::MotionEvent &event);
	...
	private:
		GnuVGConnector *ctx;
		std::function<void(GnuVGConnector *context, double zoom, double x, double y)> callback;
	...
	public:
		ZoomTransition(GnuVGConnector *context,
			       std::function<void(GnuVGConnector *context, double zoom, double x, double y)> callback,
	...
	GnuVGCornerButton plus_button, trash_button, settings_button;
	GnuVGListView list_view;

	KammoGUI::GnuVGCanvas::ElementReference pan_and_zoom;
	...
	static void zoom_callback(GnuVGConnector *ctx, double zoom, double x, double y);

	// connection list data
	std::shared_ptr<GnuVGConnectionList> connection_list;
	...
	static void on_pan_and_zoom_event(KammoGUI::GnuVGCanvas::SVGDocument *source,
					  KammoGUI::GnuVGCanvas::ElementReference *e_ref,
					  const KammoGUI::MotionEvent &event);
