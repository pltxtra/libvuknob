...
bool MachineSequencer::PadMotion::process_motion(bool mute, MidiEventBuilder *_meb) {
...
void MachineSequencer::Pad::process_sessions(bool mute, int tick, MidiEventBuilder *_meb) {
