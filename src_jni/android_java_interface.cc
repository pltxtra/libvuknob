...
extern "C" {
	JNIEXPORT void Java_com_holidaystudios_libvuknob_JavaInterface_SetupInterface
	...
	JNIEXPORT void Java_com_holidaystudios_libvuknob_JavaInterface_AddService
