...
SERVER_CODE(
	BaseMachine::Controller::Controller(int _ctrl_id, Machine::Controller *ctrl) : ctrl_id(_ctrl_id) {
		name = ctrl->get_name();
	...
	std::string BaseMachine::Controller::get_serialized_controller() {
...
CLIENT_CODE(
	BaseMachine::Controller::Controller(std::function<
...
SERVER_N_CLIENT_CODE(
	...
	void BaseMachine::Controller::serderize_controller(SerderClassT& iserder) {
