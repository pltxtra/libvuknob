...
extern "C" {
	...
	JNIEXPORT void Java_com_holidaystudios_libvuknob_VuknobAndroidAudio_registerNativeAudioConfigurationData
	...
	JNIEXPORT jboolean Java_com_holidaystudios_libvuknob_VuknobAndroidAudio_javaThread
